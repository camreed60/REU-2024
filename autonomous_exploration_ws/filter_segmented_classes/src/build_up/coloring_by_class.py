...
class SegmentationPointCloud:
    ...
    def create_colored_pointcloud(self):
        ...
        print("Checkpoint 3: ", current_time)
    ...
    def transform_pointcloud(self, pointcloud, source_frame, target_frame):
        try:
            self.tf_listener.waitForTransform(target_frame, source_frame, rospy.Time(0), rospy.Duration(0))
            ...
            #debugging
            current_time = time.time()
            print("Checkpoint 4: ", current_time)
            ...
            # Debugging
            current_time = time.time()
            print("Checkpoint 5: ", current_time)
